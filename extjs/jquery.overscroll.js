 ...
 */
// Search for "DPT" to see changes needed to use default cursor on map
...
(function(global, dom, browser, math, wait, cancel, namespace, $, none){
        ...
        function stop(event) {
                ...
                target.css('cursor', "default" /*compat().cursor.grab*/);  // DPT Change
        ...
        function setup(target, options) {
                ...
                if (sizing.valid || options.ignoreSizing) {
                        ...
                        data.target = target = $(target).css({
                                position: 'relative',
                                cursor: 'default' /*compat().cursor.grab*/  // DPT Change
